...
import (
	auth "ikuzports/features/auth"

	mock "github.com/stretchr/testify/mock"
)

// AuthRepo is an autogenerated mock type for the RepositoryInterface type
type AuthRepo struct {
	mock.Mock
}

// FindUser provides a mock function with given fields: email
func (_m *AuthRepo) FindUser(email string) (auth.Core, error) {
	ret := _m.Called(email)
